...
# number of input, hidden and output nodes (50 * 50 Pixels)
input_nodes = 2500
hidden_nodes = 1600
# 8 possible outputs: 0 -> 2€ 1 -> 1ct 1€ -> 7
output_nodes = 8
...
training_data_file = open("data/TrainAllData.csv", 'r')
...
test_data_file_10 = open("data/TestAllData.csv", 'r')
...
# load the mnist test data CSV file into a list
test_data_file = open("data/TestAllData.csv", 'r')
